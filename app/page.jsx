      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">{features.map((feature,index) => {
            return (
              <Card key={index}
              className="border-2 hover:border-primary transition-colors duration-300 ease-in-out shadow-lg hover:shadow-xl"
              >
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <p className="text-muted-foreground">
            Four simple steps to elevate your career with Sensai:
            </p>
            </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-muted/50">
       ...
       <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <p className="text-muted-foreground">
            Have questions? We have answers! Here are some common queries about Sensai:
            </p>
            </div>
      ...
      <section className="w-full">
        <div className="mx-auto py-24 gradient rounded-lg">
          ...
          <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl">
            Unlock your potential and take the first step towards a brighter future with Sensai.
            </p>
